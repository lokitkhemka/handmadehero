...
HANDMADE_SLOW
0:No Slow code like Assert Macros
1:Slow code like Assert Macros are enabled
...
#define DEBUG_PLATFORM_WRITE_FILE(name) bool32 name(thread_context *Thread, char *FileName, uint32 MemorySize, void *Memory)
typedef DEBUG_PLATFORM_WRITE_FILE(debug_platform_write_file);

#endif

//Four Things needed: timing,
